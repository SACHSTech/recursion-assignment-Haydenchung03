...
public class Recursion {
  ...
  */
  public static int count8(int intN) {
    ...
    if (intN == 0) {
      return 0;
    // If number is divided and the remainder is equal to 8 and the number divided is divided by 10 and the remainder is 8, run this code. Returns the value of the intN divided by 10 and adds 2.
    } else if(intN % 10 == 8 && (intN / 10) % 10 == 8) {
      return 2 + count8(intN / 10);
    // If number is divided by 10 and the remainder is 8, run this code. Returns the value of intN divided by 10 and adds 1.
    } else if(intN % 10 == 8) {
      return 1 + count8(intN / 10);
    // If none of the other conditions run, this condition would run. Returns the value of intN divided by 10.
    } else {
